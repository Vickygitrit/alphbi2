          ...
          <div className="flex justify-between">
            <div className="relative flex-grow">
              <input
                ...
                className="search-gif block w-full rounded-lg border-gray-300 bg-gray-100 py-2 px-4 text-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm"
              />
              <button
